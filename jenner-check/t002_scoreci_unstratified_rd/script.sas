...
*** Single-stratum test cases from tests/v_scoreci.sas,
*** including examples from Newcombe 1998 and boundary cases
*** (0% and 100% event rates in rows 5-8);
DATA DS4;
...
title "Unstratified MN intervals (Newcombe 1998 examples)";
...
title "Unstratified SCAS intervals";
