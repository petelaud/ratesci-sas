...
*** EXAMPLE 1 from tests/v_scoreci.sas:
*** stratified risk difference, demonstrating that the test produced by
*** SCORECI with MH weights (PVAL_2SIDED) reproduces the CMH test p=0.0485
*** and the stratified Miettinen-Nurminen interval is coherent with it;
DATA DS1;
